...
{#if medPendingRemoval}
	<ConfirmDialog
		title={i18n.t('med_remove_confirm_title')}
		description={i18n.t('med_remove_confirm_desc').replace('{name}', medPendingRemoval.name)}
		confirmLabel={i18n.t('med_remove_confirm')}
		cancelLabel={i18n.t('med_remove_cancel')}
		onConfirm={confirmRemoveMedicine}
